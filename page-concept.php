    ...
    <div class="site-section pt-0">
      <div class="container">
        <div class="row justify-content-center">
          <div class="site-margin-top-section col-12 col-lg-8 bg-cyan text-white">
            <div class="site-section pb-0">
              <div class="container">
                <div class="row">
                  <div class="site-section-heading text-center w-border mx-auto col-12" data-aos="fade-up" data-aos-delay="100">
                    <div class="mx-auto">
                      <h2 class="text-white font-weight-bold text-center mx-3">CONCEPT</h2>
                      ...
                      <a href="<?= esc_url(home_url('/'));?>" ontouchstart=""><button class="btn btn-show type2 mx-auto" ontouchstart="">コンテンツを見る</button></a>
                    </div>
                  </div>
                </div>
              </div>
