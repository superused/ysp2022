      ...
      <div class="container p-md-0">
        ...
        <div class="project-title">
          <div class="project-id">
            <div class="word fadeup">PROJECT</div>
            <div class="number fadeup"><?= substr('0' . $data->project_id, -2); ?></div>
          </div>
          <div class="title fadeup"><?= strtoupper($data->name); ?></div>
        </div>
        <div class="project container md fadeup">
          <p class="explain fadeup"><?= $data->text1; ?></p>
          <div class="profile">
...
<?php   foreach ($images as $image): ?>
          <div class="thumbnail col-12 col-md-4 px-3 mb-4 text-center fadeup">
