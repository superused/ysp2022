...
$datas = [
  ...
  12 => ["zhT9oPIfbGo","大好き、私達の八百屋さん","ヘリオトロープ","日頃お世話になっている地元の八百屋さん。本当に家族のような温かい関係をたくさんの方と作られています。人だけでなく動物にも愛される八百屋さんです。"],
  ...
  14 => ["hULHdmDg_Ls","大須観音と大須商店街（愛知県名古屋市）","一誠","名古屋の観光名所「大須商店街」。食べ歩きを楽しめる観光スポットとして、休日は多くの人で賑わいます。今回は、大須商店街で買える、おすすめの食べ歩きグルメをご紹介！フォトジェニックなSNS映えスイーツや、手軽に味わえる名古屋めしなども楽しめます！"],
        ...
        <div class="row">
          <div class="col-12 col-md-8">
            ...
            <div class="site-section py-5" data-aos="fade-up" data-aos-delay="100">
              <div class="container">
                <div class="row">
                  <p class="text-left mx-3">「My Favorite Town」をテーマに、町の魅力を収めたショートムービーの数々が寄せられました。実行委員による審査の末、総合グランプリが決定しました！<br>いよいよ結果発表です！</p>
                </div>
              </div>
            </div>
<?php $count = 0; ?>
