...
<?php include 'parts/input-bar.php'; ?>
        <div class="font-weight-bold h5 mb-5">送信完了しました。</div>
        <div class="font-weight-bold small mb-6">
          <p>口座振込のお手続きいただきありがとうございます。<br><br class="d-md-none">ご入力いただいたメールアドレスに、<br class="d-md-none">振込先の口座をご案内いたしました。<br>メールをご確認ください。</div>
      </div>
    </div>
