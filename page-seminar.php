<?php get_header(); ?>
    ...
    <div class="site-section site-section-sm pt-4 pt-md-5">
    ...
    <div id="seminar-events" class="site-section site-section-sm">
      <div class="container">
        <div class="title-icon normal mb-6">セミナー・イベントの紹介</div>
        <div class="row">
