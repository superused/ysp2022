...
<ul class="slider top fadeup">
  <li><a href="<?= ABOUT_URL; ?>"><div><p class="font-weight-500">やりがい<br><span class="batsu"></span><br>地域活性化</p><button class="btn btn-normal btn-slider">1ページで分かるYSP</button><video src="<?= IMG_DIR; ?>/top.mp4" type="video/mp4" playsinline autoplay loop muted></video></div></a></li>
