...
<?php include 'parts/input-bar.php'; ?>
        <div class="font-weight-bold h5 mb-5 fadeup">入会申込書請求完了しました。</div>
        <div class="font-weight-bold small mb-6 fadeup">入会申込書請求いただきありがとうございます。<br>ご入力いただいたご住所に申込書を郵送いたしますので、<br>ご記入・捺印のうえ10日以内にご返送をお願いします。</div>
      </div>
    </div>
