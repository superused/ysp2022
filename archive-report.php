<?php get_header(); ?>
    <div class="report site-section site-section-sm fadeup">
      <div class="container">
        ...
        <div class="box team-member overflow-bg-white fadeup">
          <div class="title fadeup"><?php the_title(); ?></div>
          <div class="subtitle fadeup">
            <div class="tags">
...
?>
        ...
        <div class="site-section p-0 my-4 fadeup">
...
?>
          <div class="item fadeup"><a href="<?= get_permalink(); ?>"><?php the_title(); ?></a></div>
<?php
  endwhile;
endif; ?>
        </div>
