            ...
            <div class="site-section py-5" data-aos="fade-up" data-aos-delay="100">
              <div class="container">
                <div class="row">
                  ...
                  <p class="text-left ml-3 mr-3">「コロナ禍で気づいたこと」をテーマに五・七・五の川柳を募集しました！改めて気づいた家族や大切な人との繋がり、実際に経験したことなど、素敵な作品が800も寄せられました！<br><br>あなたの気に入った川柳に、ぜひ投票してみてください！投票結果で順位が決まります！<br><br>（現在表示されている投票数は8月7日時点のものです。8月8日の投票数は表示されず、明日18時に最終結果を発表します。）</p>
                </div>
              </div>
            </div>
