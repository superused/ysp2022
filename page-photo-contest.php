...
<?php endif; ?>
            ...
            <div class="site-section py-5" data-aos="fade-up" data-aos-delay="100">
              <div class="container">
                <div class="row">
                  <p class="text-left ml-3 mr-3">「地域の魅力」を感じるひとコマをテーマに7月4日まで募集しました。応募があった全194作品の中から選ばれた10作品を掲載しています。<br><br>あなたが素敵だと思う写真に、ぜひ投票してみてください！投票結果で順位が決まります！<br><br>（現在表示されている投票数は8月7日時点のものです。8月8日の投票数は表示されず、明日18時に最終結果を発表します。）</p>
                </div>
              </div>
            </div>
