    <footer class="site-footer<?= !empty($noMargin) ? ' mt-0' : ''; ?>">
      <div class="container pt-5">
        <div class="row">
          <div class="text-center mb-5 col-12 d-md-none" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="footer-link-box mb-4 col-12 text-center">
            <div class="footer-link-upper" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="footer-link-value"><a href="<?= GOODS_SHOP_URL; ?>" class="link text-center mx-auto" ontouchstart="">グッズショップ（外部サイト）</a></div>
