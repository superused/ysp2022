      ...
      <div class="footer-menu bg-lightgray py-4">
          ...
          <div class="row">
            <ul class="menu-left col-md-8 mb-3 mb-md-5 px-0 px-md-3">
              ...
              <div class="footer-link-circle d-md-table">
                <div class="d-md-table-cell fadeup"><a href="<?= ABOUT_URL; ?>">YSPとは<span class="small font-weight-bold ml-1">- 1ページで分かるYSP -</span></a></div>
                <div class="d-md-table-cell fadeup"><a href="<?= OUTLINE_URL; ?>" class="pankuzu-next">団体概要</a></div>
                <div class="d-md-table-cell fadeup"><a href="<?= MESSAGE_URL; ?>" class="pankuzu-next">会長挨拶</a></div>
              </div>
              </li>
              <li>
              <div class="footer-link-circle fadeup">
            ...
            <ul class="menu-right col-md-4 footer-line-left text-left text-md-center font-weight-bold mb-3 mb-md-5">
              <li class="footer-link-circle right shop fadeup">
              ...
              <li class="footer-link-circle right magazine fadeup">
        ...
        <div class="container p-0">
           <div class="row text-center align-items-center mx-0 mb-5 mb-md-4">
             <div class="footer-image col-md-3 p-0 pb-2 pb-md-0 text-md-left mx-auto mx-md-0 fadeup">
...
*/ ?>
             ...
             <div class="footer-contact col-md-3 p-0 pb-2 pb-md-0 fadeup">
               <a href="<?= CONTACT_URL; ?>" class="btn btn-normal mark-cyan rounded mx-auto">お問い合わせ</a>
             </div>
           </div>
           <div class="w-100 text-center pt-3 fadeup">
             <span>Copyright © YSP-Japan All Rights Reserved</span>
           </div>
        </div>
      </div>
    </footer>
    <a class="page_top fadeup" href="#" ontouchstart=""><span></span></a>
    ...
    <script src="<?= get_template_directory_uri(); ?>/js/jquery.inview.min.js"></script>
